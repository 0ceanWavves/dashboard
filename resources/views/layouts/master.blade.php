...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('assets/auth/') }}" data-template="vertical-menu-template">
  <head>
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <title>@yield('title', 'Default Title') | Your App Name</title>
    ...
    <script src="{{ asset('assets/auth/vendor/js/template-customizer.js') }}"></script>
  ...
  <ul>
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{ asset('assets/auth/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                              </div>
                            </div>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                              <img src="{{ asset('assets/auth/img/avatars/2.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                              <img src="{{ asset('assets/auth/img/avatars/9.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                              <img src="{{ asset('assets/auth/img/avatars/5.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{ asset('assets/auth/img/avatars/6.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Congratulations Kyle! 🎉</h5>
                          <p class="mb-4">
                            You have done <span class="fw-medium">100%</span> more awesome than anyone knows!
                          </p>
                      ...
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            ...
                            height="140"
                            alt="View Badge User"
                            data-app-dark-img="{{ asset('assets/auth/img/illustrations/man-with-laptop-dark.png') }}"
                            class="img-fluid"
                            />
                      </div>
                    </div>
                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{ asset('assets/auth/img/icons/unicons/wallet-info.png') }}"
                                alt="Credit Card"
                                class="rounded" />
                            </div>
                            <div class="dropdown">
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="{{ asset('assets/auth/img/icons/unicons/paypal.png') }}" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                      ...
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          <div class="d-flex p-4 pt-3">
                            <div class="avatar flex-shrink-0 me-3">
                              <img src="{{ asset('assets/auth/img/icons/unicons/wallet.png') }}" alt="User" />
                            </div>
                            <div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/auth/img/icons/unicons/paypal.png') }}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/auth/img/icons/unicons/wallet.png') }}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/auth/img/icons/unicons/chart.png') }}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/auth/img/icons/unicons/cc-success.png') }}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('assets/auth/img/icons/unicons/cc-warning.png') }}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex">
                              <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                <img
                                  src="{{ asset('assets/auth/img/icons/misc/pdf.png') }}"
                                  alt="PDF image"
                                  width="23"
                                  class="me-2" />
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex flex-wrap">
                              <div class="avatar me-3">
                                <img src="{{ asset('assets/auth/img/avatars/3.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div>
                          ...
                          <div class="timeline-event pb-0">
                            ...
                            <div class="d-flex align-items-center avatar-group">
                              <div
                                ...
                                <img src="{{ asset('assets/auth/img/avatars/5.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Marrie Patty">
                                <img src="{{ asset('assets/auth/img/avatars/12.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Jimmy Jackson">
                                <img src="{{ asset('assets/auth/img/avatars/9.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Kristine Gill">
                                <img src="{{ asset('assets/auth/img/avatars/6.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Nelson Wilson">
                                <img src="{{ asset('assets/auth/img/avatars/14.png') }}" alt="Avatar" class="rounded-circle" />
                              </div>
                            </div>
                          </div>
                        </li>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/chrome.png') }}"
                                      alt="Chrome"
                                      height="24"
                                      class="me-2" />
                                    <span>Chrome</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/safari.png') }}"
                                      alt="Safari"
                                      height="24"
                                      class="me-2" />
                                    <span>Safari</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/firefox.png') }}"
                                      alt="Firefox"
                                      height="24"
                                      class="me-2" />
                                    <span>Firefox</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/edge.png') }}"
                                      alt="Edge"
                                      height="24"
                                      class="me-2" />
                                    <span>Edge</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                        src="{{ asset('assets/auth/img/icons/brands/opera.png') }}"
                                      alt="Opera"
                                      height="24"
                                      class="me-2" />
                                    <span>Opera</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/brave.png') }}"
                                      alt="Brave"
                                      height="24"
                                      class="me-2" />
                                    <span>Brave</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/vivaldi.png') }}"
                                      alt="Vivaldi"
                                      height="24"
                                      class="me-2" />
                                    <span>Vivaldi</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/uc.png') }}"
                                      alt="UC Browser"
                                      height="24"
                                      class="me-2" />
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/windows.png') }}"
                                      alt="Windows"
                                      height="24"
                                      class="me-2" />
                                    <span>Windows</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/mac.png') }}"
                                      alt="Mac"
                                      height="24"
                                      class="me-2" />
                                    <span>Mac</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/ubuntu.png') }}"
                                      alt="Ubuntu"
                                      height="24"
                                      class="me-2" />
                                    <span>Ubuntu</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/cent.png') }}"
                                      alt="Cent"
                                      height="24"
                                      class="me-2" />
                                    <span>Cent</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/linux.png') }}"
                                      alt="Linux"
                                      height="24"
                                      class="me-2" />
                                    <span>Linux</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                      src="{{ asset('assets/auth/img/icons/brands/fedora.png') }}"
                                      alt="Fedora"
                                      height="24"
                                      class="me-2" />
                                    <span>Fedora</span>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <img
                                    src="{{ asset('assets/auth/img/icons/brands/vivaldi-os.png') }}"
                                      alt="Vivaldi"
                                      height="24"
                                      class="me-2" />
                                    <span>Vivaldi</span>
    ...
    <script src="{{ asset('assets/auth/vendor/libs/hammer/hammer.js') }}"></script>
    <script src="{{ asset('assets/auth/vendor/libs/i18n/i18n.js') }}"></script>
    <script src="{{ asset('assets/auth/vendor/libs/typeahead-js/typeahead.js') }}"></script>
...
function updateFrontendAfterLogout() {
  ...
  $.ajax({
    url: '/check-auth', // Make sure this route exists
    type: 'GET',
