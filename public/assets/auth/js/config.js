...
if (typeof TemplateCustomizer !== 'undefined') {
    window.templateCustomizer = new TemplateCustomizer({
      ...
      // defaultTheme: 2,
      // defaultStyle: 'system',
      // defaultTextDir: 'ltr', // Ensure this is set to 'ltr'
      ...
      controls: ['style', 'headerType', 'contentLayout', 'layoutCollapsed', 'layoutNavbarOptions', 'themes'] // Removed 'rtl' from controls
    });
  }
